<?php 
include "init.php";
if($_SESSION['is_users']==1){
    header("location:index.php");
    exit;
}
if(isset($_POST['password']) && !empty($_POST['password'])){
    
    $is_true=$users->setting_user([$_POST['email'],$_POST['password']],"SELECT * FROM users where user_mail=? and user_password=?");
    if(count($is_true)>0){
        $users->set_session($is_true[0]['user_id']);
        
        header("location:giris.php?durum=ok&id={$_SESSION['is_users']}");
        exit;
    }else{
         header("location:giris.php?durum=no&message=Mail veye şifreniz hatalı.");
         exit;
    }
}
                  ...
                  ">
                            ...
                            <div class="col-md-12">
                                <div class="form-area" style=" width:80%; margin:auto;">
                                    <form method="post" style="margin:5px;width:100%;">
                                        ...
                                        <div class="form-group" style="width:100%;">
                                            <button class="btn btn-success" name="login" style="width:100%;">Giriş</button>
                                        </div>
