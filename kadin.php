                        ...
                        <div class="row kadin-tags">
                            <div class="col-md-6 kadin-left-side">
                                <div class="row">
                                    <h2>GİYİSİLER</h2>
                                    <ul class="kadin-ul">
                                        <li><a href="product.php">asdasd</a></li>
                                       <li><a href="product.php">asdasd</a></li><li><a href="product.php">asdasd</a></li><li><a href="product.php">asdasd</a></li><li><a href="product.php">asdasd</a></li><li><a href="product.php">asdasd</a></li><li><a href="product.php">asdasd</a></li><li><a href="product.php">asdasd</a></li><li><a href="product.php">asdasd</a></li>
                                    </ul>
                                </div>
                                <div class="row kadin-left">
                                    <div class="col-md-6">
                                        <a href="product-detail.php">
                                            <img class="img-responsive vsv-zoom-image loaded" src="https://staticpages.mngbcn.com/homes/images/fw20/mm/agosto/cardigans_she.jpg?imwidth=475&imdensity=1">
                                            <div class="kadin-img-text">Hırka</div>
                                        </a>
                                    </div>
                                    <div class="col-md-6">
                                           <a href="product-detail.php">
                                            <img class="img-responsive vsv-zoom-image loaded" src="https://staticpages.mngbcn.com/homes/images/fw20/mm/agosto/cardigans_she.jpg?imwidth=475&imdensity=1">
                                            <div class="kadin-img-text">Ayakkabı</div>
                                        </a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 kadin-right-side">
                                <img style="width:100%;" src="http://staticpages.mngbcn.com/homes/images/fw20/mm/agosto/vestidos_she.jpg?imwidth=1903&imdensity=1">
                                <div class="kadin-img-text">Elbise</div>
                            ...
                            <div class="kadin-new-row">
                                <div class="news-product">
                                    ...
                                    <div class="row kadin-text-row">
                                        <span class="kadin-text">Elbise</span>
                                        <span class="kadin-text">.--249.99 TL</span>
                                    </div>
                                </div>
                                <div class="news-product">
                                    <img class="img-responsive vsv-zoom-image loaded" src="https://staticpages.mngbcn.com/homes/images/fw20/mm/agosto/cardigans_she.jpg?imwidth=475&imdensity=1">
